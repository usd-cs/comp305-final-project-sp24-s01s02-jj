...
public class FacultyTest {
    ...
    private static final Date FAKE_FACULTY_DOB = new Date(2004 - SQL_DATE_OFFSET, 5, 6);
    ...
    private static final Date FAKE_FACULTY_START_DATE = new Date(2024 - SQL_DATE_OFFSET, 5, 4);
